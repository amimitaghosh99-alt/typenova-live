...
You are Challenger 1. Your working directory is `c:\Users\risho\OneDrive\Desktop\typenova-v2 - Copy\.agents\teamwork_preview_challenger_m1_1`. Create your working directory if needed.
...
Document all empirical test code, command outputs, and pass/fail results in `c:\Users\risho\OneDrive\Desktop\typenova-v2 - Copy\.agents\teamwork_preview_challenger_m1_1\handoff.md`. Send a message back to parent when done.
