...
export const AccountMenu = ({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <div
        className={`!absolute bottom-full mb-2 right-0 w-52 glass-panel rounded-2xl overflow-hidden origin-bottom-right transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] z-[1000] ${open ? 'opacity-100 scale-100 translate-y-0 pointer-events-auto' : 'opacity-0 scale-95 translate-y-4 pointer-events-none'}`}
      >
