...
import { 
  ...
  Radio, MessageSquare, Send, Sparkles
} from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto relative select-none pb-2 animate-in fade-in duration-300 flex flex-col gap-4">
      ...
      >
        ...
        {/* Room Code Capsule */}
        <div className="glass-panel px-6 py-1.5 rounded-full border border-white/20 flex items-center gap-5 shadow-[0_8px_30px_rgba(0,0,0,0.4)] bg-black/50">
          ...
          <div className="flex items-center gap-1.5">
            <button
              onClick={copyCode}
              className="px-3.5 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 text-zinc-200 hover:text-white transition-all active:scale-95 cursor-pointer flex items-center gap-1.5 text-xs font-mono font-bold"
            ...
            <button
              onClick={copyLink}
              className="px-3.5 py-1.5 rounded-xl bg-cyan-500/15 hover:bg-cyan-500/25 border border-cyan-500/30 text-cyan-300 hover:text-cyan-100 transition-all active:scale-95 cursor-pointer flex items-center gap-1.5 text-xs font-mono font-bold"
